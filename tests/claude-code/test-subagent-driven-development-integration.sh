...
# IMPORTANT: Run from wolfpowers directory so local dev skills are available
...
if grep -q '"name":"Skill".*"skill":"wolfpowers:subagent-driven-development"' "$SESSION_FILE"; then
