...
mkdir -p "$HOME/.config/opencode/wolfpowers"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/wolfpowers/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/wolfpowers/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/wolfpowers/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/superpowers.js" "$HOME/.config/opencode/wolfpowers/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/wolfpowers/.opencode/plugins/superpowers.js" \
       "$HOME/.config/opencode/plugins/wolfpowers.js"
...
echo "Plugin installed to: $HOME/.config/opencode/wolfpowers/.opencode/plugins/superpowers.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/wolfpowers.js"
